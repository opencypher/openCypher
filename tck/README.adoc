...
* Cineasts
** A social graph of movies, with actors and directors, and users who rate the movies.

For instructions on how to use the named graph descriptions and metadata, please see link:named-graphs.adoc[Named Graphs].
