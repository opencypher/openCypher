...
Cypher defines certain exceptional behaviour, and all errors produced by a Cypher implementation is categorized into one of the following categories:
...
- ParameterMissing               "The statement is referring to a parameter that was not provided in the request."
- ConstraintVerificationFailed   "A constraint imposed by the statement is violated by the data in the database."
- EntityNotFound                 "The statement is directly referring to an entity that does not exist."
- PropertyNotFound               "The statement is referring to a property that does not exist."
- LabelNotFound                  "The statement is referring to a label that does not exist."
...
- ArithmeticError                "Invalid use of arithmetic, such as dividing by zero."
