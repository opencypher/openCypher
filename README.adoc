...
= The Cypher Property Graph Database Query Language
...
This repository holds the specification of Cypher, the declarative property graph database query language.
...
* https://github.com/opencypher/openCypher/issues?q=is%3Aissue+is%3Aopen+label%3ACIP[Open Cypher Improvement Proposals]
