...
_Definition_: A *composite statement* is either a single statement or an operator clause chain that is optionally followed by another composite statement (using vertical juxtaposition syntax).
