...
.4+|Predicates
.3+|6
|https://raw.githack.com/openCypher/openCypher/master/tools/grammar-production-links/grammarLink.html?p=StringOperatorExpression[String predicates] (left-hand operand)
|
...
|https://raw.githack.com/openCypher/openCypher/master/tools/grammar-production-links/grammarLink.html?p=ListOperatorExpression[List predicates] (left-hand operand)
|
