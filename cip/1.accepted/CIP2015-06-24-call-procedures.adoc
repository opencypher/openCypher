...
A special argument `*` (star) may be given to the `YIELD` subclause in the standalone form.
...
As a further simplification, the `YIELD` subclause can be omitted altogether in a standalone procedure call, leading to an even more concise syntax:
